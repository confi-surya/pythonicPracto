...
from osd.objectService.unitTests import fake_http_connect
...
class TestObjectController(unittest.TestCase):
    ...
    def open_manage(self):
        open_orig = diskfile.DiskFile.open
        yield
        diskfile.DiskFile.open = open_orig


    
    @mock.patch("osd.objectService.objectutils.http_connect", mock_acquire_lock(200, {'x-request-trans-id': "123"}))
    def test_GET(self):
        req = Request.blank('/fs1/a1/d1/o1/a/c', environ={'REQUEST_METHOD': 'GET', 'HTTP_X_GLOBAL_MAP_VERSION': 4.0}, headers={'X-Container-Host': '1.2.3:0000'})
        resp = req.get_response(self.object_controller)
        self.assertEquals(resp.status_int, 400)
        req = Request.blank('/fs1/a1/d1/o1/a/c/o', environ={'REQUEST_METHOD': 'GET', 'HTTP_X_GLOBAL_MAP_VERSION': 4.0}, headers={'X-Container-Host': '1.2.3:0000'})
        resp = req.get_response(self.object_controller)
        ...
        req = Request.blank('/fs1/a1/d1/o1/a/c/o', environ={'REQUEST_METHOD': 'GET', 'HTTP_X_GLOBAL_MAP_VERSION': 4.0},
    ...
    def test_GET_acquire_lock_503(self):
        timestamp = normalize_timestamp(time())
        req = Request.blank('/fs1/a1/d1/o1/a/c/o',
                            environ={'REQUEST_METHOD': 'GET','HTTP_X_GLOBAL_MAP_VERSION': 4.0},
                            headers={'X-Timestamp': timestamp, 'X-Container-Host': '1.2.3:0000'})
        resp = req.get_response(self.object_controller)
    ...
    @mock.patch("osd.objectService.server.get_global_map", mock_get_global_map)
    def test_GET_acquire_lock_409(self):
        timestamp = normalize_timestamp(time())
        req = Request.blank('/fs1/a1/d1/o1/a/c/o',
                            environ={'REQUEST_METHOD': 'GET','HTTP_X_GLOBAL_MAP_VERSION': 4.0},
                            headers={'X-Timestamp': timestamp, 'X-Container-Host': '1.2.3:0000'})
    ...
    def test_GET_acquire_lock_fail_400(self):
        timestamp = normalize_timestamp(time())
        req = Request.blank('/fs1/a1/d1/o1/a/c/o',
                            environ={'REQUEST_METHOD': 'GET','HTTP_X_GLOBAL_MAP_VERSION': 4.0},
                            headers={'X-Timestamp': timestamp, 'X-Container-Host': '1.2.3:0000'})
    ...
    @mock.patch("osd.objectService.objectutils.http_connect", mock_acquire_lock(200, {}))
    def test_GET_acquire_lock_exception(self):
    ...
    @mock.patch("osd.objectService.objectutils.http_connect", mock_acquire_lock(200, {'x-request-trans-id': "123"}))
    def test_GET_add_exception(self):
    ...
    @mock.patch("osd.objectService.objectutils.http_connect", mock_acquire_lock(200, {'x-request-trans-id': "123"}))
    def test_GET_open_exception(self):
        with self.open_manage():
            diskfile.DiskFile.open = mock.MagicMock(side_effect=DiskFileNotExist)
            LockManager.delete = mock.MagicMock()
            TranscationManager.release_lock = mock.MagicMock()
            timestamp = normalize_timestamp(time())
            req = Request.blank('/fs1/a1/d1/o1/a/c/o',
                                environ={'REQUEST_METHOD': 'GET', 'HTTP_X_GLOBAL_MAP_VERSION': 4.0},
                                headers={'X-Timestamp': timestamp, 'X-Container-Host': '1.2.3:0000'})
            ...
            self.assertTrue(LockManager.delete.called)
            self.assertTrue(TranscationManager.release_lock.called)
            self.assertFalse(self.lock_mgr_obj.is_exists('fd2d8dafa0570422b397941531342ca4/6eff33b3ff33852f4cfb514aaa7f5199/d1c91d91068a170a6bcf220efe77711d'))
