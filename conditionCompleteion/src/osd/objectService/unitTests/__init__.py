...
from osd.common.utils import config_true_value, LogAdapter
from hashlib import md5
from eventlet import sleep, Timeout
import logging.handlers
from httplib import HTTPException
from numbers import Number
from osd.common.ring.ring import ObjectRingData
...
class FakeObjectRing(object):
    ...
    def get_container_level_directory(self, account, container, obj):
        return 'd0'

    def get_account_level_directory(self, account, container, obj):
	return 'a1'

    def get_filesystem(self, directory):
        return 'fs0'

    def get_node(self, account, container, obj, only_fs_dir_flag=True):
        if only_fs_dir_flag:
            return 'fs1', 'a1/d0/o1'
        return [self.ring_data.object_service_list[0]['os_1']], \
            'fs1', 'a1/d0/o1', self.ring_data.global_map_version, \
             self.ring_data.component_number
...
class FakeContainerRing(object):
    ...
    def get_node(self, account, container):
        return [self.ring_data.container_service_list[0]['cs_1']], \
            'fs1', 'a1', self.ring_data.global_map_version, \
             self.ring_data.component_number
...
class FakeAccountRing(object):
    ...
    def get_node(self, account):
        return [self.ring_data.account_service_list[0]['as_1']], \
            'fs1', account, self.ring_data.global_map_version, \
             self.ring_data.component_number
