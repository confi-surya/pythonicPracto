...
Why not osd.common.utils, you ask? Because this way we can import things
...
from osd.common.constraints import FORMAT2CONTENT_TYPE
from osd.common.exceptions import ListingIterError, SegmentError
from osd.common.http import is_success, HTTP_SERVICE_UNAVAILABLE
from osd.common.swob import HTTPBadRequest, HTTPNotAcceptable
from osd.common.utils import validate_device_partition
from osd.common.helper_functions import split_path
from osd.common.wsgi import make_subrequest
...
def is_param_exist(req, name):
    """
    Check parameter existence from an HTTP request ensuring proper
...
class SegmentedIterable(object):
    ...
    :param swift_source: value of osd.source in subrequest environ
                         (just for logging)
