...
from osd.common.utils import cache_from_env, get_logger, register_osd_info
from osd.proxyService.controllers.base import get_container_memcache_key, \
    get_account_info
from osd.common.memcached import MemcacheConnectionError
