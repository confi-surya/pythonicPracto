...
from osd.common.swob import Response, Request
from osd.common.swob import HTTPBadRequest, HTTPForbidden, HTTPNotFound, \
    HTTPUnauthorized

from osd.common.request_helpers import get_sys_meta_prefix
from osd.common.middleware.acl import (
    clean_acl, parse_acl, referrer_allowed, acls_from_account_info)
from osd.common.utils import cache_from_env, get_logger, \
    config_true_value, register_osd_info
...
class TempAuth(object):
    ...
    def authorize_for_bandwidth_limit(self, req):
        ...
        :return: True if X-Account-Max-Read-Bandwidth or
                 X-Account-Max-Read-Bandwidth exists in request headers.
                 False otherwise.
...
def filter_factory(global_conf, **local_conf):
    ...
    register_osd_info('tempauth', account_acls=True)
